...
# Board-specific port layer
if(TARGET_BOARD STREQUAL "stm32f3_discovery")
    set(BOARD_PORT_SOURCES "src/port/stm32f3_port.c")
    set(BOARD_BSP_SOURCES "src/bsp/stm32f3_discovery_bsp.c")
elseif(TARGET_BOARD STREQUAL "stm32f4_discovery")
    set(BOARD_PORT_SOURCES "src/port/stm32f4_port.c")
    set(BOARD_BSP_SOURCES "src/bsp/stm32f4_discovery_bsp.c")
elseif(TARGET_BOARD STREQUAL "rp2040_pico_w")
    set(BOARD_PORT_SOURCES "src/port/rp2040_port.c")
    set(BOARD_BSP_SOURCES "src/bsp/rp2040_pico_w_bsp.c")
else()
    message(FATAL_ERROR "No port implementation found for board ${TARGET_BOARD}")
endif()
...
message(STATUS "Port sources: ${BOARD_PORT_SOURCES}")
message(STATUS "BSP sources: ${BOARD_BSP_SOURCES}")
